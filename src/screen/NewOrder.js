  ...
  return (
    <View style={Theme.displayFlex}>
      ...
      <View style={[Theme.pageBody, Theme.center]}>
        ...
        <Text style={Theme.marginTop10}>Tambahkan Alamat Penerima</Text>
        <View style={[Theme.textInputContainer, Theme.marginTop20]}>
          <TextInput
            style={Theme.textInputDoubleIcon}
        ...
        <View>
          <TouchableOpacity style={[Theme.defaultButton, Theme.marginTop40s]}>
            <Text style={Theme.defaultTextButton}>Pesan</Text>
          </TouchableOpacity>
        </View>
      </View>
